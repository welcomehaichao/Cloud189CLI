...
- [x] Token 持久化
- [x] Session 管理
- [x] **Session自动刷新** - v1.2.0
- [x] 登录状态检查

### ✅ 高级功能
- [x] **配置加密存储** - AES-256-GCM加密（v1.2.0）
- [x] **日志审计系统** - 操作日志记录（v1.2.0）
- [x] 上传功能（旧版+Stream）
- [x] 下载功能（支持断点续传）
- [x] 秒传功能
- [x] 进度显示
...
- [x] 获取家庭云列表
- [x] 家庭云文件列表
- [x] **家庭云切换（family use）** - v1.2.0
- [x] **家庭云转存（family save）** - v1.2.0
...
- [x] share-cancel - 取消分享
- [x] family list - 家庭云列表
- [x] family use - 切换家庭云（v1.2.0）
- [x] family save - 转存文件（v1.2.0）
- [x] log - 日志管理（v1.2.0）
